  ...
  return (
    <div className="group relative w-44 sm:w-48 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 hover:border-indigo-500/40 rounded-2xl p-4 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 flex flex-col items-center text-center shrink-0">
      ...
      <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden bg-slate-900 mb-3 group-hover:shadow-lg shadow-md border-2 border-slate-700/60 group-hover:border-indigo-500/50 transition-all duration-300">
        ...
        {artist.verified && (
          <div className="absolute bottom-1 right-1 bg-indigo-600 text-white rounded-full p-1 border-2 border-slate-900" title="Verified Artist">
      ...
      {/* Artist Details */}
      <h3 className="font-semibold text-slate-100 text-sm line-clamp-1 group-hover:text-indigo-400 transition-colors w-full">
        {artist.name}
      </h3>
      <p className="text-xs text-slate-400 mt-1 line-clamp-1">{formatListeners(artist.monthlyListeners)}</p>
      <span className="mt-2 text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 bg-indigo-500/10 text-indigo-300 rounded-full border border-indigo-500/20">
        Artist
      </span>
    </div>
  );
