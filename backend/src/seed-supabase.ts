...
export const seedSupabase = async () => {
  try {
    console.log('🌱 Starting HarmonyAI Supabase Seed...');

    // 1. Clear existing catalog data
    console.log('🧹 Clearing existing Songs, Albums, Artists, and Genres in Supabase...');
    ...
    const genreData = [
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=600&auto=format&fit=crop',
      ...
      },
      {
        ...
        cover_image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600&auto=format&fit=crop',
        tags: ['indie', 'folk', 'acoustic', 'chill'],
        is_featured: true,
      },
    ];

    const { data: genres, error: genreErr } = await supabase.from('genres').insert(genreData).select();
    if (genreErr || !genres) throw new Error(`Genre seed error: ${genreErr?.message}`);
    ...
    const artistData = [
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('electronic'), genreMap.get('pop')].filter(Boolean) as string[],
        monthly_listeners: 1250000,
        verified: true,
      ...
      },
      {
        ...
        banner_image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=1200&auto=format&fit=crop',
      ...
      },
      {
        ...
        banner_image: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('electronic')].filter(Boolean) as string[],
        monthly_listeners: 2400000,
        verified: true,
      ...
      },
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('r-and-b')].filter(Boolean) as string[],
        monthly_listeners: 760000,
        verified: true,
        tags: ['rnb', 'soul', 'chill'],
      },
      {
        ...
        banner_image: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('rock')].filter(Boolean) as string[],
        monthly_listeners: 1540000,
        verified: true,
      ...
      },
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('hip-hop')].filter(Boolean) as string[],
        monthly_listeners: 3100000,
        verified: true,
      ...
      },
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=1200&auto=format&fit=crop',
      ...
      },
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('jazz')].filter(Boolean) as string[],
        monthly_listeners: 380000,
        verified: false,
      ...
      },
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=1200&auto=format&fit=crop',
      ...
      },
      {
        ...
        profile_image: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&auto=format&fit=crop',
        banner_image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=1200&auto=format&fit=crop',
        genres: [genreMap.get('indie')].filter(Boolean) as string[],
        monthly_listeners: 540000,
        verified: false,
        tags: ['folk', 'acoustic', 'chill'],
      },
    ];

    const artistInsertData = artistData.map(({ genres, ...rest }) => rest);
    const { data: artists, error: artistErr } = await supabase.from('artists').insert(artistInsertData).select();
    if (artistErr || !artists) throw new Error(`Artist seed error: ${artistErr?.message}`);

    const artistMap = new Map(artists.map((a) => [a.name, a.id]));

    // Seed artist_genres
    const artistGenrePairs: { artist_id: string; genre_id: string }[] = [];
    for (const a of artistData) {
      const aId = artistMap.get(a.name);
      if (aId && a.genres) {
        for (const gId of a.genres) {
          if (gId) artistGenrePairs.push({ artist_id: aId, genre_id: gId });
        }
      }
    }
    if (artistGenrePairs.length > 0) {
      await supabase.from('artist_genres').insert(artistGenrePairs);
    }
    ...
    const albumData = [
      {
        title: 'Neon Skyline',
        artist_id: artistMap.get('The Midnight Wave') || defaultArtistId,
        genre_id: genreMap.get('electronic') || null,
        cover_image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&auto=format&fit=crop',
        release_year: 2023,
        album_type: 'album',
        total_tracks: 4,
      ...
      },
      {
        ...
        artist_id: artistMap.get('Luna Resonance') || defaultArtistId,
        genre_id: genreMap.get('indie') || null,
        cover_image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&auto=format&fit=crop',
        release_year: 2024,
        album_type: 'album',
        total_tracks: 5,
      ...
      {
        title: 'Overdrive',
        artist_id: artistMap.get('Apex Pulse') || defaultArtistId,
        genre_id: genreMap.get('electronic') || null,
        cover_image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&auto=format&fit=crop',
        release_year: 2024,
        album_type: 'album',
        total_tracks: 5,
        tags: ['edm', 'dance'],
      },
      {
        ...
        artist_id: artistMap.get('Velvet Groove') || defaultArtistId,
        genre_id: genreMap.get('r-and-b') || null,
        cover_image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500&auto=format&fit=crop',
        release_year: 2023,
        album_type: 'album',
        total_tracks: 5,
        tags: ['rnb', 'soul'],
      ...
      {
        title: 'Thunder & Dust',
        artist_id: artistMap.get('Echoes of Orion') || defaultArtistId,
        genre_id: genreMap.get('rock') || null,
        cover_image: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&auto=format&fit=crop',
        release_year: 2022,
        album_type: 'album',
        total_tracks: 5,
      ...
      },
      {
        ...
        artist_id: artistMap.get('Rhythm & Rhyme') || defaultArtistId,
        genre_id: genreMap.get('hip-hop') || null,
        cover_image: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=500&auto=format&fit=crop',
        release_year: 2025,
        album_type: 'album',
        total_tracks: 5,
        tags: ['hiphop', 'rap'],
      },
      {
        ...
        artist_id: artistMap.get('Starlight Quartet') || defaultArtistId,
        genre_id: genreMap.get('classical') || null,
        cover_image: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=500&auto=format&fit=crop',
        release_year: 2021,
        album_type: 'album',
        total_tracks: 5,
      ...
      },
      {
        ...
        artist_id: artistMap.get('Blue Horizon') || defaultArtistId,
        genre_id: genreMap.get('jazz') || null,
        cover_image: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=500&auto=format&fit=crop',
        release_year: 2023,
        album_type: 'album',
        total_tracks: 5,
        tags: ['jazz', 'relaxing'],
      },
      {
        ...
        artist_id: artistMap.get('Solaris Nova') || defaultArtistId,
        genre_id: genreMap.get('pop') || null,
        cover_image: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=500&auto=format&fit=crop',
        release_year: 2024,
        album_type: 'album',
        total_tracks: 5,
        tags: ['synthpop', 'pop'],
      },
      {
        ...
        artist_id: artistMap.get('Acoustic Drift') || defaultArtistId,
        genre_id: genreMap.get('indie') || null,
        cover_image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&auto=format&fit=crop',
        release_year: 2023,
        album_type: 'album',
        total_tracks: 5,
        tags: ['folk', 'acoustic'],
    ...
    const { data: albums, error: albumErr } = await supabase.from('albums').insert(albumData).select();
    if (albumErr || !albums) throw new Error(`Album seed error: ${albumErr?.message}`);

    const albumMap = new Map(albums.map((al) => [al.title, al.id]));

    // 5. Seed 50 Songs
    console.log('🎶 Seeding 50 Songs with Audio Features & Metadata...');
    const songTemplates = [
      // Pop Songs (1-7)
    ...
    const songsToInsert = songTemplates.map((tmpl, idx) => {
      ...
      return {
        title: tmpl.title,
        artist_id: artistId || defaultArtistId,
        album_id: albumId || null,
        genre_id: genreId || genres[0].id,
        duration: tmpl.duration,
        cover_image: `https://images.unsplash.com/photo-${1518709268805 + idx}?w=500&auto=format&fit=crop`,
    ...
    const { data: songs, error: songErr } = await supabase.from('songs').insert(songsToInsert).select();
    if (songErr || !songs) throw new Error(`Song seed error: ${songErr?.message}`);

    console.log('\n==================================================');
    console.log('🎉 HarmonyAI Supabase Seeding Complete Successfully!');
    console.log('==================================================');
